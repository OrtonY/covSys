...
urlpatterns = [
    ...
    path('to_a_alter_quarantine/', views.to_a_alter_quarantine, name="to_a_alter_quarantine"),
    path('a_alter_quarantine/', views.a_alter_quarantine, name="a_alter_quarantine"),
